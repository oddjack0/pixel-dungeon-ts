...
// Stage 3 worker addition (Dwarf King): the king's original sprites live in
// their own module (src/assets/stage3_king_sprites.ts) because
// original_sprites.ts is generated by scripts/extract_original_sprites.ts,
// which is frozen for the extraction worker. Merged into the same lookup.
import { STAGE3_KING_SPRITES } from '../assets/stage3_king_sprites.js';
// Stage 3 integration: the city tiles, imp-quest/class-armor sprites, and
// subclass/tome sprite live in their own generated modules (same provenance
// convention as the king sprites above). Merged into the same lookup.
